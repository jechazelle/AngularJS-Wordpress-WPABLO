...
footerController.$inject = ['$rootScope', '$scope', '$location' ,'$timeout'];

function footerController($rootScope, $scope, $location, $timeout) {
...
function homeController($rootScope, $scope, $location, $timeout) {
